...
class TestEntityManager {
   ...
   */
  public function __construct($entity_type , $bundle, $field_map_overrides = array('published' => 'status', $class = 'TestDrupal\BehatExtension\Context\TestEntityManager')) {
