...
namespace TestDrupal\BehatExtension\Context\Annotation;
...
class Reader implements AnnotationReader {
   ...
   * @var string
   */
  private static $regex = '/^\@(beforenodecreate|afternodecreate|beforetermcreate|aftertermcreate|beforeusercreate|afterusercreate|beforetestdrupalentitycreate|aftertestdrupalentitycreate)(?:\s+(.+))?$/i';
  ...
  private static $classes = array(
    ...
    'beforetestdrupalentitycreate' => 'TestDrupal\BehatExtension\Hook\Call\BeforeTestDrupalEntityCreate',
    'aftertestdrupalentitycreate' => 'TestDrupal\BehatExtension\Hook\Call\AfterTestDrupalEntityCreate',
  );
